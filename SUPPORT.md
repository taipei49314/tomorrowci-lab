...
|----------|--------------|------------------------------|
| Linux x86_64 | alpha.2 archive + public CI build | Docker: measured Python runtime slice plus bounded M2 pip/npm/cargo dependency reduction; Podman and broader M3 Node/Rust runtime paths **NOT_RUN** |
...
| Node.js | npm only | Bounded M2 Linux Docker dependency/ddmin **PASS**; broader M3 runtime, Podman, and platform qualification **NOT_RUN** |
| Rust | cargo | Bounded M2 Linux Docker dependency/ddmin **PASS**; broader M3 runtime, Podman, and platform qualification **NOT_RUN** |
